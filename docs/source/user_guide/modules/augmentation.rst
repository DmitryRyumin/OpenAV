...
.. csv-table::
   ...
   "contrast_min", "float", "``0``", "Минимальное значение коэффициента контрастности по оси Y. Диапазон значений от ``-10.0`` и ``10.0``"
   "contrast_max", "float", "``1.0``", "Максимальное значение коэффициента контрастности по оси Y. Диапазон значений от ``-10.0`` и ``10.0``"
   "alpha", "float", "``0.7``", "Значения коэффициента MixUp. Диапазон значений от ``-10.0`` и ``10.0``"
