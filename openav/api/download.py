...
"""
Поиск, проверка и загрузка данных
"""
...
class MessagesDownload(Run):
    ...
    def __post_init__(self):
        ...
        self._description: str = self._("Поиск, проверка и загрузка данных")
...
# ######################################################################################################################
@dataclass
class RunDownload(MessagesDownload):
    """Класс для поиска, проверки и загрузки данных"""
    ...
    def __post_init__(self):
        ...
        self._logger_run_download: logging.Logger = logging.getLogger(__class__.__name__)
    ...
    def run(self, metadata: ModuleType = openav, resources: ModuleType = rsrs, out: bool = True) -> bool:
        """Запуск поиска, проверки и загрузки данных
        ...
        if out is True:
            ...
            self._logger_run_download.info(self._description)
            Shell.add_line()  # Добавление линии во весь экран
...
def main():
    # Запуск поиска, проверки и загрузки данных
    vad = RunDownload(lang="ru", path_to_logs="./openav/logs")
    vad.run(out=True)
